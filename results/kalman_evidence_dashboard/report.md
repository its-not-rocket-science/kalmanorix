...
| Kalman vs mean | yellow | `inconclusive_underpowered` from `results/kalman_latency_optimisation/canonical/summary.json` |
| Kalman vs weighted mean | yellow | `inconclusive_underpowered` from `results/kalman_latency_optimisation/canonical/summary.json` |
| Kalman vs router only top1 | yellow | `inconclusive_underpowered` from `results/kalman_latency_optimisation/canonical/summary.json` |
...
- `results/kalman_latency_optimisation/canonical/summary.json`
