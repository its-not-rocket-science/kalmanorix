...
**Answer:** Correlation-aware Kalman improved over baseline Kalman (best: corr_kalman_cov_inflation, ΔMRR@10=0.0037).

## Test metrics (strengthened split)

| Method | Recall@1 | Recall@5 | MRR@10 |
| --- | ---: | ---: | ---: |
| mean_fusion | 0.3500 | 0.6833 | 0.4929 |
| baseline_kalman | 0.3929 | 0.7214 | 0.5318 |
| corr_kalman_cov_inflation | 0.3952 | 0.7262 | 0.5356 |
| corr_kalman_effective_sample_size | 0.3929 | 0.7214 | 0.5318 |
