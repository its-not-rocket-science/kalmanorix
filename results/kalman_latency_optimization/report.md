...
- Kalman optimised scalar-σ²: mean=0.840 ms, p50=0.794 ms, p95=1.118 ms, mem_proxy=2761.5 KiB
- Speedup (legacy -> optimised): 2.05x
- Optimised Kalman / Mean latency ratio: 2.37x
...
- Kalman optimised batch: mean=14.754 ms, p50=14.169 ms, p95=17.895 ms, mem_proxy=3950.3 KiB
- Batch speedup (legacy -> optimised): 1.22x
...
- Canonical artifacts: `results/kalman_latency_optimisation/canonical/summary.json` and `results/kalman_latency_optimisation/canonical/report.md`
