"""
Create an interactive Jupyter notebook for Kalmanorix routing and fusion visualization.

This script generates examples/interactive_demo.ipynb with:
- Explanatory markdown cells
- Interactive widgets for query input and parameter tuning
- Real-time visualization of routing decisions and fusion weights
- Demonstrations of semantic routing with dynamic thresholding
- Fusion strategy comparisons

The notebook is self-contained and uses synthetic/toy data for demonstration.
"""
...
# Notebook structure using nbformat v4
NOTEBOOK_VERSION = 4
NOTEBOOK_FORMAT = "json"
...
def create_notebook() -> Dict[str, Any]:
    ...
    # Cells - we'll build them incrementally
    ...
    # Cell 2: Installation instructions (code)
    cells.append(
        {
            "cell_type": "code",
            "metadata": {},
    ...
    cells.append(
        {
            ...
            "source": [
                ...
                "from kalmanorix.embedder_adapters import OpenAIEmbedder  # Example of proprietary adapter\n",
                "from kalmanorix.village import compute_domain_centroid\n",
    ...
    # Cell 4: Helper functions (toy embedder from minimal_fusion_demo)
    cells.append(
        {
            "cell_type": "code",
            "metadata": {},
    ...
    # Cell 5: Create specialists with domain centroids
    cells.append(
        {
            "cell_type": "code",
            "metadata": {},
            ...
            "source": [
                ...
                '    "battery", "smartphone", "cpu", "gpu", "laptop",\n',
                '    "android", "ios", "camera", "charger", "processor"\n',
                "}\n",
                "\n",
                "cook_keywords: Set[str] = {\n",
                '    "braise", "simmer", "slow cooker", "recipe", "garlic",\n',
                '    "onion", "saute", "oven", "stew", "bake"\n',
                "}\n",
                "\n",
                "medical_keywords: Set[str] = {\n",
                '    "symptom", "diagnosis", "treatment", "patient", "medicine",\n',
                '    "hospital", "doctor", "nurse", "prescription", "recovery"\n',
                "}\n",
                "\n",
                "# Create embedders\n",
    ...
    # Cell 6: Explanation of semantic routing
    cells.append(
        {
            "cell_type": "markdown",
            "metadata": {},
    ...
    # Cell 7: Interactive widget for routing exploration
    cells.append(
        {
            "cell_type": "code",
            "metadata": {},
            ...
            "source": [
                ...
                "        threshold = threshold_relative_to_max(query, query_vec, similarities, \n",
                "                                             fraction=param1, min_threshold=param2)\n",
                '    elif threshold_type == "adaptive_spread":\n',
                "        threshold = threshold_adaptive_spread(query, query_vec, similarities,\n",
                "                                            spread_factor=param1, min_threshold=param2)\n",
                '    elif threshold_type == "query_length":\n',
                "        threshold = threshold_query_length_adaptive(query, query_vec, similarities,\n",
                "                                                   length_factor=param1, base_threshold=param2)\n",
                "    else:\n",
                ...
                "    colors = ['lightgreen' if sim >= threshold else 'lightcoral' \n",
                ...
                "    if selected_names:\n",
                "        ax2.bar(range(len(selected_names)), [1]*len(selected_names), \n",
                ...
                "        ax2.set_ylim(0, 1.5)\n",
                "    else:\n",
                "        ax2.text(0.5, 0.5, 'No modules selected', \n",
                ...
                "    \n",
                "    if keywords_found:\n",
                "        ax3.bar(range(len(keywords_found)), list(keywords_found.values()), \n",
                ...
                "widgets.interactive(explore_routing,\n",
                "                   query=query_widget,\n",
    ...
    # Cell 8: Fusion strategies comparison
    cells.append(
        {
            "cell_type": "markdown",
            "metadata": {},
    ...
    # Cell 9: Interactive fusion visualization
    cells.append(
        {
            "cell_type": "code",
            "metadata": {},
            ...
            "source": [
                ...
                "        plot_embedding_with_uncertainty(\n",
                "            emb, cov,\n",
                "            title=f'{first_module.name} Embedding ±1σ',\n",
                "            ax=ax2, show=False\n",
                "        )\n",
                "    \n",
                ...
                ")\n",
                "\n",
                "routing_widget = widgets.Checkbox(\n",
                "    value=True,\n",
                "    description='Use semantic routing'\n",
                ")\n",
                "\n",
                ...
                "\n",
                "# Connect widgets\n",
                "widgets.interactive(compare_fusion,\n",
    ...
    # Cell 10: Conclusion and next steps
    cells.append(
        {
            "cell_type": "markdown",
            "metadata": {},
...
def main():
    ...
    # Write notebook
    notebook_path = examples_dir / "interactive_demo.ipynb"
    with open(notebook_path, "w", encoding="utf-8") as f:
        json.dump(notebook, f, indent=2)

    print(f"Created interactive notebook at: {notebook_path}")
    print(f"To run: jupyter notebook {notebook_path}")
    print("\nNote: The notebook uses ipywidgets for interactivity.")
    print("Install with: pip install ipywidgets matplotlib")
