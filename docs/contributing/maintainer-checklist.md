...
- Re-run canonical benchmark artifacts:
  - `PYTHONPATH=src python experiments/run_canonical_benchmark.py --benchmark-path benchmarks/mixed_beir_v1.2.0/mixed_benchmark.json --split test --max-queries 1200 --output-dir results/canonical_benchmark_v3`
