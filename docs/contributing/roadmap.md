...
This roadmap reflects the actual development status and prioritises the critical path to validating the KEFF (Kalman Ensemble of Fusion-Frugal specialists) hypotheses.
...
- **Target:** Fusion adds < 10 ms latency for d = 768, 5 specialists
