...
The current claim-ready fast-local benchmark does not support Kalman fusion superiority over mean fusion; hard routing is the strongest observed method.

## Narrative and planning documents

- [Publication plan](./publication-plan.md)
- [Negative-result framing](./negative-result-framing.md)
- [Preprint draft: *Kalman Fusion Negative Result*](./kalman_fusion_negative_result_preprint.md)
