...
- Default `SEFModel.from_pretrained` behaviour is non-executable: metadata, covariance, and alignment load safely.
...
This design improves defensibility for JOSS by making unsafe behaviour opt-in, auditable, and test-covered.
